<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DemoTest.aspx.cs" Inherits="TeacherList" %>
                ...
                <div id="header">
                    ...
                    <div id="menubar">
                        <ul id="menu">
                            ...
                            <li class="selected"><a href="DemoTest.aspx">DemoTest</a></li>
                      ...
                      <asp:BoundField DataField="time" HeaderText="Time" />
                        ...
                        <asp:Panel ID="Panel1" Visible="false" runat="server">
                            ...
                            <p>Branch Name : <asp:Label ID="lblnranch" runat="server" Text="Label"></asp:Label></p>
                             ...
                             <p>Subject Name:<asp:Label Visible="false" ID="lblsubject" runat="server" Text="Label"></asp:Label>
                        ...
                        <asp:Panel ID="Panel3" Visible="false" runat="server">
                            ...
                            <h1>Time Over<asp:Label ID="lblmessage" runat="server" Text="Label"></asp:Label>
                                &nbsp;</h1>
                            <p>
