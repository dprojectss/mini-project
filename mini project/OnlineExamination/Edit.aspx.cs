...
public partial class Edit : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("update studreg set username = '" + TextBox1.Text + "', password = '" + TextBox2.Text + "' where username='" + TextBox1.Text + "'", con);
            cmd.ExecuteNonQuery();
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("update techreg set username = '" + TextBox1.Text + "', password = '" + TextBox2.Text + "' where username='" + TextBox1.Text + "'", con);
            cmd.ExecuteNonQuery();
            Response.Write("<script LANGUAGE='JavaScript' >alert('Successfully Updated!')</script>");
            con.Close();
